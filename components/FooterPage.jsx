...
const FooterBar = () => {
    ...
    {/* Navbar com fundo escuro levemente transparente e efeito fosco */}
            <nav className="relative flex items-center bg-transparent bg-opacity-50 backdrop-blur-lg rounded-full px-2.5 py-3 shadow-lg w-full max-w-md mx-2">
        {menuItems.map((item) => {
                ...
                <>
                    ...
                    <div className="relative z-20">
                        <Icon
                            ...
                            className={isActive ? 'text-white' : 'text-gray-300'}  // Ícones brancos no tema escuro
                        />
                    </div>
                </>
            );
