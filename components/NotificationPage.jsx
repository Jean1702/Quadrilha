  ...
  return (
    <main className="min-h-screen px-4 py-6 pb-24">
      <div className="max-w-3xl mx-auto space-y-4">
        <section className="bg-[var(--surface)] rounded-[24px] p-5 shadow-lg border border-black/5">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-11 h-11 rounded-2xl bg-[var(--bg)] flex items-center justify-center shadow-inner">
              <Bell className="text-[var(--footer)]" size={20} />
            </div>
            <div>
        ...
        {loading ? (
          ...
          <section className="space-y-3">
            {pedidosAtivos.map((pedido) => {
              ...
              return (
                <article key={pedido.idvenda} className="bg-[var(--surface)] rounded-[24px] p-5 shadow-lg border border-black/5">
                  <div className="flex items-start justify-between gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2 rounded-full px-3 py-1.5 bg-[var(--bg)]">
