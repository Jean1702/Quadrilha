...
export default function SkeletonHome() {
    return (
        <div className="min-h-screen w-full overflow-x-hidden p-4 md:p-8">
            ...
            {/* Simulando o Swiper com um flex overflow */}
            <div className="flex gap-4 overflow-hidden pb-4">
                {[1, 2, 3, 4, 5].map((i) => (
                    <div
                        key={`cat-${i}`}
                        className="card card-compact bg-base-100 shadow-xl shrink-0 w-[140px] md:w-[160px] overflow-hidden border border-slate-100 dark:border-slate-800"
                    >
                        {/* Imagem da Categoria (Cor mais forte: slate-500) */}
                        ...
                        {/* Texto da Categoria */}
                        <div className="p-3 bg-[var(--surface)] flex justify-center items-center">
            ...
            <div className="flex flex-col gap-6 md:flex-row md:gap-4 md:overflow-hidden">
                {[1, 2, 3].map((i) => (
                    ...
                    >
                        {/* Imagem do Restaurante (Cor mais forte com Ícone do Flowbite) */}
