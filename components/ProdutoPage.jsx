...
export default function ProdutoPage() {
    ...
    return (
        <div className="min-h-screen bg-[#DFD0AF] text-[#514442] font-sans">
            ...
            <div className="flex justify-center -mt-6 relative z-10">
                <Stack spacing={2} className='bg-[#DFD0AF] shadow-md border border-[#514442]/10 rounded-full px-2 py-1'>
                    <Pagination
                        ...
                        sx={{
                            '& .MuiPaginationItem-root': { color: '#514442' },
                            '& .Mui-selected': { backgroundColor: '#D95032 !important', color: '#DFD0AF' }
                        }}
                    />
                </Stack>
            </div>
            ...
            <main className="container max-w-lg mx-auto p-6 flex flex-col gap-8">
                ...
                <section className="text-center space-y-4">
                    <h1 className="text-4xl font-black uppercase tracking-tighter text-[#514442]">
                        {products[page - 1]?.nome}
                    </h1>
                    <p className='text-sm leading-relaxed text-[#514442]/80'>
                        {products[page - 1]?.descricao}
                    </p>
                </section>

                <section className="flex flex-col gap-2">
                    <label className="text-xs font-bold uppercase text-[#514442]/60 ml-1">Observações</label>
                    <TextareaAutosize
                        minRows={3}
                        placeholder="Ex: Sem cebola, ponto da carne, etc..."
                        className='w-full bg-[#DFD0AF] text-[#514442] border-2 border-[#514442]/20 p-4 rounded-xl focus:border-[#D95032] outline-none transition-colors placeholder:text-[#514442]/50'
                    />
                </section>

                <footer className="flex flex-col gap-6 mt-auto">
                    <div className="flex items-center justify-between bg-[#DFD0AF] border border-[#514442]/10 p-4 rounded-2xl shadow-sm">
                        ...
                        <div className="text-right">
                            <p className="text-xs uppercase font-bold text-[#514442]/60">Subtotal</p>
